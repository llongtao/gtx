package com.gtx.common.loader;

import com.gtx.common.constants.GtxConstants;
import com.gtx.common.executor.Initialize;
...
public class EnhancedServiceLoader {
    ...
    private static final String SEATA_DIRECTORY = "META-INF/gtx/";
    ...
    private static void loadFile(Class<?> service, String dir, ClassLoader classLoader, List<Class> extensions)
        ...
        if (urls != null) {
            while (urls.hasMoreElements()) {
                ...
                try {
                    reader = new BufferedReader(new InputStreamReader(url.openStream(), GtxConstants.DEFAULT_CHARSET_NAME));
                    String line = null;
